        # Javascript Vue.js Frontend Application — Node 12

        **Scenario:** 1 - Monolithic  
        **Project type:** Vue.js Frontend Application  
        **Customer Version:** 12  
        **Syntax:** ES2019 / Node.js 12 — no ?./??, no Object.hasOwn/.at/toSorted/findLast; Array.flat/flatMap, Object.fromEntries

        ## Source of truth

        - Mapping matrix: `Final_Enterprise_Mapping_Matrix 1.xlsx` (JavaScript sheet)
        - Syntax / tool fixture patterns: `Golden_Repo_Lite` → `Javascript_12.0.0`
        - This branch contains **only** Node 12 syntax (no cross-version merge)
...
- [`stryker-js`](tools/stryker-js/) → `npm run tool:stryker-js`
        ...
        | Path | Purpose |
        |---|---|
        | `src/` | Vue app + domain JS (ES2019 / Node.js 12) |
        ...
        | `Dockerfile` | Node 12 multi-stage build |
        | `jsconfig.json` | Editor/build language service for ES2019 |
