        # Javascript Vue.js Frontend Application — Node 16

        **Scenario:** 1 - Monolithic  
        **Project type:** Vue.js Frontend Application  
        **Customer Version:** 16  
        **Syntax:** ES2021 / Node.js 16 — replaceAll, Promise.any, logical assignment — no Object.hasOwn/.at/toSorted/findLast

        ## Source of truth

        - Mapping matrix: `Final_Enterprise_Mapping_Matrix 1.xlsx` (JavaScript sheet)
        - Syntax / tool fixture patterns: `Golden_Repo_Lite` → `Javascript_16.0.0`
        - This branch contains **only** Node 16 syntax (no cross-version merge)
...
- [`stryker-js`](tools/stryker-js/) → `npm run tool:stryker-js`
        ...
        | Path | Purpose |
        |---|---|
        | `src/` | Vue app + domain JS (ES2021 / Node.js 16) |
        ...
        | `Dockerfile` | Node 16 multi-stage build |
        | `jsconfig.json` | Editor/build language service for ES2021 |
