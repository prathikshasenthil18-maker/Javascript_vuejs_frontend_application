        # Javascript Vue.js Frontend Application — Node 14

        **Scenario:** 1 - Monolithic  
        **Project type:** Vue.js Frontend Application  
        **Customer Version:** 14  
        **Syntax:** ES2020 / Node.js 14 — ?. , ?? , Promise.allSettled, globalThis — no Object.hasOwn/.at/toSorted/findLast

        ## Source of truth

        - Mapping matrix: `Final_Enterprise_Mapping_Matrix 1.xlsx` (JavaScript sheet)
        - Syntax / tool fixture patterns: `Golden_Repo_Lite` → `Javascript_14.0.0`
        - This branch contains **only** Node 14 syntax (no cross-version merge)
...
- [`stryker-js`](tools/stryker-js/) → `npm run tool:stryker-js`
        ...
        | Path | Purpose |
        |---|---|
        | `src/` | Vue app + domain JS (ES2020 / Node.js 14) |
        ...
        | `Dockerfile` | Node 14 multi-stage build |
        | `jsconfig.json` | Editor/build language service for ES2020 |
